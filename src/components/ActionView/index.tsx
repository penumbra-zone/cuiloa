...
const CommunityPoolSpend: FC<{ communityPoolSpend: CommunityPoolSpendT }> = ({ communityPoolSpend }) => {
  ...
  return (
    <FlexCol className="w-full">
      <p className="w-full">Community Pool Spend</p>
      {value ? <Value value={value} label="Deposit Value"/> : null}
    </FlexCol>
  );
};
