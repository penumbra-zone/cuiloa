...
import { Header } from "@buf/cosmos_ibc.bufbuild_es/ibc/lightclients/tendermint/v1/tendermint_pb";
...
// Provides registry types for decoding known typeURLs in ibcRelayAction.rawAction.Any
